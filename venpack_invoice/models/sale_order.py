...
class CustomSaleOrder(models.Model):
    ...
    product_id = fields.Many2one('product.product', string="Nombre del Producto", compute="_compute_first_line_fields", store=True)
    x_presentacion = fields.Char(string="Presentación", compute="_compute_first_line_fields", store=True)
    uom_id = fields.Many2one('uom.uom', string="Unidad de Medida", compute="_compute_first_line_fields", store=True)
    x_tipop = fields.Char(string="Tipo de Producto", compute="_compute_first_line_fields", store=True)
    x_tipox = fields.Char(string="Tipo de Extrusión", compute="_compute_first_line_fields", store=True)
