...

{
    ...
    "price": 29.00 ,
    'currency': "EUR",
    'summary': 'point of sales multi currency payment POS Multiple Currency payment pos payment different currency allow multi currency payment on pos multiple currency payment in Point of Sale pay order with different currency pos Payment Multi Currency payment on pos',
    "description": """   
    ...
    'assets': {
        'point_of_sale.assets': [
            ...
            '/bi_pos_multi_currency/static/src/js/OrderDetailsInherit.js',
            '/bi_pos_multi_currency/static/src/js/button.js',
            '/bi_pos_multi_currency/static/src/js/BiPaymentScreen.js',
            '/bi_pos_multi_currency/static/src/js/bi_payment_scree_status.js',
            '/bi_pos_multi_currency/static/src/js/biPaymentScreenPaymentLines.js'
        ],
        'web.assets_qweb': [
