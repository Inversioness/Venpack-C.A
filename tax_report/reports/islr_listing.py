...
class IslrListing(models.AbstractModel):
    _name = 'report.tax_report.islr_listing'
    _description = 'listado de islr pdf'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        invoice_ids = self.env['account.move'].search([('id', 'in', docids), ('journal_id', 'in', journal_ids.ids)]).sorted(key=lambda r: r.date)
