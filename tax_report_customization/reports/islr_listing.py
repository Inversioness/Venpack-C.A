...
class IslrListingCustomization(models.AbstractModel):
    _inherit = 'report.tax_report.islr_listing'
    _description = 'Customization of listado ISLR: return empty docargs when no docids'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        return super(IslrListingCustomization, self)._get_report_values(docids, data=data)
